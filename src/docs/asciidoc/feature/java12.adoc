...
.Java 12
----
include::{java-code}/java12/StringTest.java[tag=transform]
----
...
.Java 12
----
include::{java-code}/java12/StringTest.java[tag=transform2]
----
...
.Java 12
----
include::{java-code}/java12/StringTest.java[tag=transform3]
----
...
.Java 12
----
include::{java-code}/java12/StringTest.java[tag=indent]
----
...
.Java 12
----
include::{java-code}/java12/FileTest.java[tag=mismatch]
----
...
.Java 12
----
include::{java-code}/java12/StreamApi.java[tag=teeing]
----
