...
.Java 11
----
include::{java-code}/java11/SynchronousHttpClient.java[]
----
...
.Java 11
----
include::{java-code}/java11/AsynchronousHttpClient.java[]
----
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=repeat]
----
+
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=repeatWithRegex]
----
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=isBlank]
----
+
[NOTE]
.isBlank() vs isEmpty()
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=isEmpty]
----
====
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=strip]
----
+
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=stripWithRegex]
----
...
.Java
----
include::{java-code}/java11/StringApi.java[tag=lines]
----
...
.Java
----
include::{java-code}/java11/CollectionApi.java[tag=toArray]
----
...
.Java
----
include::{java-code}/java11/FilesApi.java[tag=readString]
----
...
.Java
----
include::{java-code}/java11/FilesApi.java[tag=writeString]
----
...
.Java
----
include::{java-code}/java11/OptionalApi.java[tag=optional]
----