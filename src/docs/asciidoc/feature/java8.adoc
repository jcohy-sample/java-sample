...
[NOTE]
====
注意：及时省略了 `@FunctionalInterface` 注解，函数接口也是可用的，这个注解仅用于通知编译器在接口内强制执行单个抽象方法
...
.Java
----
include::{java-code}/java8/function/MyFunctionInterface.java[]
----
...
.Java
----
include::{java-code}/java8/function/Moveable.java[]
----
...
新的日期和时间API/类（https://jcp.org/en/jsr/detail?id=310[JSR-310]），也称为 ThreeTen，只是改变了我们在 Java 应用程序中处理日期的方式。
...
.TestLocalDate
----
include::{java-code}/java8/date/TestLocalDate.java[]
----

[source,java,indent=0,subs="verbatim,quotes",role="primary"]
.TestLocalTime
----
include::{java-code}/java8/date/TestLocalTime.java[]
----
...
.Java
----
include::{java-code}/java8/date/DateTest.java[tag=offsetDateTime]
----
...
.Java
----
include::{java-code}/java8/date/DateTest.java[tag=createDate]
----
...
.Java
----
include::{java-code}/java8/date/TestClock.java[tag=createDate]
----
