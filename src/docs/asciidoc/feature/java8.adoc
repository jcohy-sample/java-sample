...
.Java
----
include::{java-code}/java8/function/ConsumerTest.java[tag=consumer1]
----
...
.Java
----
include::{java-code}/java8/function/SupplierTest.java[tag=supplier]
----
...
.Java
----
include::{java-code}/java8/function/FunctionTest.java[tag=function]
----
...
.Java
----
include::{java-code}/java8/function/PredicateTest.java[tag=predicate]
----
