...
.Java 14
----
include::{java-code}/java14/RecordTest.java[tag=record]
----
...
.Java 14
----
include::{java-code}/java14/RecordTest.java[tag=record2]
----
...
.Java 14
----
include::{java-code}/java14/RecordTest.java[tag=record3]
----
...
.Java 14
----
include::{java-code}/java14/RecordTest.java[tag=record4]
----
...
.Java 14
----
include::{java-code}/java14/RecordTest.java[tag=record5]
----
...
.Java 14
----
include::{java-code}/java14/SwitchTest.java[tag=switch1]
----
...
.Java 14
----
include::{java-code}/java14/SwitchTest.java[tag=switch2]
----
...
.Java 14
----
include::{java-code}/java14/SwitchTest.java[tag=switch3]
----
