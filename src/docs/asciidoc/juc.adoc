...
.Java
----
include::{java-code}/juc/CompareAndSwapMock.java[]
----
...
.Java
----
include::{java-code}/juc/AtomicDemo.java[]
----
...
.什么是 ABA 问题?
****
假如一个线程想要对变量 `count` 进行修改,实际操作之前获取 `count` 的值为A,此时来了一个线程将 `count` 值修改为 B,又来一个线程获取 `count` 的值为 B并将 `count` 修改为A,此时第一个线程全然不知道 `count` 的值已经被修改两次了,虽然值还是 A,但是实际上数据已经是脏的.
...
.Java
----
include::{java-code}/juc/CountDownLatchDemo.java[]
----
...
.Java
----
include::{java-code}/juc/CyclicBarrierDemo.java[]
----
...
.Java
----
include::{java-code}/juc/SemaphoreDemo.java[]
----
...
.Java
----
include::{java-code}/juc/CallableDemo.java[]
----
...
.Java
----
include::{java-code}/juc/LockDemo.java[]
----
...
.Java
----
include::{java-code}/juc/ABCAlternateDemo.java[]
----
...
.Java
----
include::{java-code}/juc/ReadWriteLockDemo.java[]
----

[source,java,indent=0,subs="verbatim,quotes",role="primary"]
.Java
----
include::{java-code}/juc/ReadWriteLockDemo2.java[]
----
...
.Java
----
include::{java-code}/juc/TestThreadPool.java[]
----
...
.Java
----
include::{java-code}/juc/ForkJoinPoolDemo.java[]
----
...
.Java
----
include::{java-code}/juc/DeadLockDemo.java[]
----
...
.Java
----
include::{java-code}/juc/TestProductorAndConsumer.java[]
----
...
.Java
----
include::{java-code}/juc/TestProductorAndConsumerForLock.java[]
----
...
.Java
----
include::{java-code}/juc/TestProductorAndConsumerForBlockQueue.java[]
----
...
.Java
----
include::{java-code}/juc/TestThread8Monitor.java[]
----
