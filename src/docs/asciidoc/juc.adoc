...
.Java
----
include::{rootProject}/java-juc/src/main/java/com/jcohy/sample/juc/ProducerAndConsumerWithWaitAntNotify.java[]
----
...
.Java
----
include::{rootProject}/java-juc/src/main/java/com/jcohy/sample/juc/ProducerAndConsumerWithLock.java[]
----
...
.Java
----
include::{rootProject}/java-juc/src/main/java/com/jcohy/sample/juc/ProducerAndConsumerWithBlockQueue.java[]
----
...
.Java
----
include::{rootProject}/java-juc/src/main/java/com/jcohy/sample/juc/ProducerAndConsumerWithSemaphore.java[]
----
